...
export default class extends Component {
    ...
    constructor(props, context) {
        ...
        this.state = {
            ...
            switchAnimation: (I18nManager.isRTL) ? new Animated.Value(value ? 1 : -1) : new Animated.Value(value ? -1 : 1)
        }
    }
    ...
    animateSwitch = (value, callback = () => null) => {
        ...
        let toValue = value ? this.offset : -this.offset;
    ...
    render() {
        let {switchAnimation, handlerAnimation, alignItems, value} = this.state
        const {
        ...
        let interpolatedTranslateX = switchAnimation.interpolate({
            inputRange: value ? [-this.offset, -1] : [1, this.offset],
        ...
        if (I18nManager.isRTL) {
            ...
            interpolatedTranslateX = switchAnimation.interpolate({
                inputRange: !value ? [-this.offset, -1] : [1, this.offset],
                outputRange: !value ? [-this.offset, -1] : [1, this.offset],
                extrapolate: 'clamp',
            });
